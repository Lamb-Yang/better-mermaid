...
在设置中写入自定义 CSS，实时生效，不依赖 Obsidian 主题：
...
搜索 "Better Mermaid"（原作者 Joven Lynn 发布的版本，不含双尺寸模式功能）。

> ⚠️ 社区市场版本为 v1.0.0，本分支基于 v1.0.5 并持续迭代，如需最新功能建议手动安装。
